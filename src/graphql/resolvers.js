...
export const resolvers = {
 ...
 if (dbUser.role === 'PRIEST') {
 throw new Error('Priest accounts no longer have access. Please contact your administrator.');
 }
 ...
 throw new Error('Only ADMIN and BISHOP accounts can be created');
 }
