    ...
    <aside className="w-64 min-h-screen bg-primary text-primary-foreground flex flex-col">
      ...
      <div className="p-6 border-b border-primary-foreground/20">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="font-bold text-sm leading-tight">Diocesan Finance</p>
      ...
      <div className="p-4 border-t border-primary-foreground/20">
        ...
        <button
          onClick={logout}
          className="flex items-center gap-3 w-full px-3 py-2 rounded-md text-sm text-primary-foreground/70 hover:bg-primary-foreground/10 hover:text-primary-foreground transition-colors"
        >
